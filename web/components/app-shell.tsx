...
/** Secondary desktop destinations, kept out of the primary navigation group. */
const secondary = [
  ["VTMS Assistant", "/assistant"],
    ...
    <AssistantProvider>
      <div className="app-shell">
        <aside className="sidebar">
          ...
          <nav className="side-nav secondary" aria-label="Secondary navigation">
